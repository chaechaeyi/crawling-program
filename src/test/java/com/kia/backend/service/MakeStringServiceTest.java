...
class MakeStringServiceTest {
    ...
    void givenTestData_whenGetCharFilter_thenPreProcessCheck() {
        // given
        String targetString = "A23****<12222aaaaBCDdddddefghIilmtv123";
        // when
        Stream<Character> characterStream = makeStringService.getCharFilter(targetString);
        // then
        // 특수문자 갯수 제거 된 갯수
        // 중복 제거 갯수 제거 된 갯수
        //
    ...
    void givenTestData_whenGetCrossSort_thenCrossSortCheck() {
        ...
        Stream<Character> targetCharStream = makeStringService.getCharFilter(targetString);
        // when
        String result = makeStringService.getCrossSort(targetCharStream);
        // then
